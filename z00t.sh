...
git clone https://github.com/AkagiShiroe/gcc-prebuilt-elf-toolchains.git -b aarch64-linux-elf/ --single-branch --depth=1 -4 aarch64-linux-elf -j$(nproc --all);
...
export CROSS_COMPILE="/usr/bin/ccache aarch64-linux-elf/aarch64-linux-elf-" ;
